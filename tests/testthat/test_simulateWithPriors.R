test_that("simulateWithPriors works", {
  ...
  simData <- simulateWithPriors(phy = simPhy, intrinsicFn = brownianIntrinsic,
    ...
    extrinsicPriorsValues = matrix(c(0, 0), nrow = 2,
      byrow = FALSE), freevector = NULL, giveUpAttempts = 10,
    verbose = FALSE, niter.brown = 25, niter.lambda = 25,
    niter.delta = 25, niter.OU = 25, niter.white = 25)
  simData
  simDataParallel <- parallelSimulateWithPriors(nrepSim = 2,
    ...
    intrinsicPriorsValues = matrix(c(10, 10), nrow = 2,
      byrow = FALSE), extrinsicPriorsFns = c("fixed"),
    extrinsicPriorsValues = matrix(c(0, 0), nrow = 2,
      byrow = FALSE), checkpointFile = NULL, checkpointFreq = 24,
    verbose = FALSE, freevector = NULL, taxon.df = NULL,
    niter.brown = 25, niter.lambda = 25, niter.delta = 25,
    niter.OU = 25, niter.white = 25)
  simDataParallel
