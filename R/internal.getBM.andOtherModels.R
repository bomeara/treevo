...
getBM<-function(phy,dat,niterN){
	fit<-makeQuiet(geiger::fitContinuous(phy=phy, dat=traits, 
...
getLambda<-function(phy,dat,niterN){
	fit<-makeQuiet(geiger::fitContinuous(phy=phy, dat=traits, 
...
getDelta<-function(phy,dat,niterN){
	fit<-makeQuiet(geiger::fitContinuous(phy=phy, dat=traits,
...
getWhite<-function(phy,dat,niterN){
	fit<-makeQuiet(geiger::fitContinuous(phy=phy, dat=traits,
