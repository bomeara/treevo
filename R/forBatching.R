...
char<-convertTaxonFrameToGeigerData (doSimulation(splits=splits,intrinsicFn=INTRINSIC,extrinsicFn=EXTRINSIC,startingStates=c(3),intrinsicValues=.06,extrinsicValues=0,timeStep=0.001),phy)
