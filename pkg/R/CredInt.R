CredInt<-function(particleDataFrame, percent=0.95) { 
	...
	subpDF<-subset(particleDataFrame[which(particleDataFrame$weight>0),], particleDataFrame$generation==max(particleDataFrame$generation))[7:dim(particleDataFrame)[2]] 
